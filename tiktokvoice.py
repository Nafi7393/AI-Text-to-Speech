...
VOICES_DICT = {"Male Voices": {'en_us_006': "English US - Male 1",
               ...
               "Female Voices": {'en_us_001': "English US - Female 1)",
                                 'en_us_002': "English US - Female 2)",
                                 'en_au_001': "English AU - Female",
                                 'de_001': "German - Female",
                                 },
               "OTHER VOICES": {'en_male_narration': "Male Narrator",
                                'en_male_funny': "Wacky - Male Funny",
                                'en_female_emotional': "Peaceful - Female Emotional"
                                },
               "DISNEY VOICES": {'en_us_ghostface': "Ghost Face",
...
current_endpoint = 0
TEXT_BYTE_LIMIT = 300  # in one conversion, the text can have a maximum length of 300 characters
...
def tts(text: str, voice: str = "none", filename: str = "output.mp3", play_sound: bool = False) -> str:
    ...
    if get_api_response().status_code == 200:
        ...
        if get_api_response().status_code == 200:
            ...
            return f"Service not available and probably temporarily rate limited, try again later..."
    
    # checking if arguments are valid
    if voice == "none":
        print("No voice has been selected")
        return "No voice has been selected"
    ...
    try:
        if len(text) < TEXT_BYTE_LIMIT:
            ...
            if audio_base64_data == "error":
                ...
                return f"The Script have some problem"
            ...
            def generate_audio_thread(text_part, index):
                ...
                if audio_base64_data == "error":
                    print("This voice is unavailable right now")
                    return "This voice is unavailable right now"
